...
@section('content-app')
    <div class="row">
        <div class="col-6">
            <div class="card">
                <div class="card-body">
                    <h4 class="mb-3"><i class="fa fa-plus"></i> Tambah Parameter</h4>
                    <form action="{{ route('parameter.store') }}" method="POST">
                        @csrf
                        <div class="form-group">
                            <label for="code">Kode Parameter</label>
                            <input type="text" name="code" id="code" class="form-control"
                                placeholder="Masukkan Kode Parameter" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name" class="form-control"
                                placeholder="Masukkan Nama Parameter" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="default_ref_range" id="default_ref_range" class="form-control"
                                placeholder="Masukkan Default Reference Range">
                        </div>
