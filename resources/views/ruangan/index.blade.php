    ...
    <div class="card">
        <div class="card-body">
            <div class="datatable-header">
                <h4 class="mb-3"><i class="fa fa-list"></i> Ruangan</h4>
                <a href="{{ url('/master/ruangan/create') }}" class="btn btn-sm btn-primary">
                            ...
                            @forelse ($ruangans as $ruangan)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ url('master/ruangan/' . $ruangan->uid . '/edit') }}"
                                            class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                                        <a href="javascript:void(0)" onclick="deleteData(`{{ $ruangan->uid }}`)"
        ...
        function deleteData(uid) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ url('master/ruangan') }}" + '/' + uid + '/destroy',
                        type: 'POST',
                        data: {
                            '_method': 'DELETE',
